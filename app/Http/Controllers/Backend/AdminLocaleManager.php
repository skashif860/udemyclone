...
class AdminLocaleManager extends Controller
{
    ...
    public function getIndex($group = null)
    {
        ...
        //$languages = Language::orderBy('is_default', 'desc')->orderBy('is_active', 'desc')->orderBy('carbon_code')->get();
        //return view('backend.settings.LocaleManager')->with(['locales' => $languages]);
